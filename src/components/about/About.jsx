    ...
    <div className="mt-[138px]">
      ...
      <div className="flex gap-5 mx-10">
        ...
        <div>
          ...
          <p className="opacity-80 text-[16px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum provident laborum commodi voluptates nisi alias tenetur soluta, inventore aliquam. Voluptatibus laborum obcaecati sed! Iure ab, et asperiores recusandae, quibusdam architecto, reprehenderit dignissimos temporibus sed modi quia? Aspernatur autem impedit harum rerum quidem, laudantium, sed explicabo excepturi nostrum quod, repellat error accusantium </p>
        </div>
      </div>
    </div>
  );
